...
async def main():
    async with async_playwright() as p:
        ...
        # Click the "New Student Registration" card
        await page.get_by_text("New Student Registration").click()

        # Wait for the form to appear
        await expect(page.get_by_placeholder("First Name")).to_be_visible()

        # Take a screenshot to observe the rendered form
        await page.screenshot(path="jules-scratch/verification/student_form_rendered.png")
